...
export const MobileNav = ({
  ...
  return (
    <div
      className={`${open ? "left-[0px]" : "left-[100%]"} transition-all fix h-[100vh] w-full fixed z-[60] top-0 bg-white`}
    >
      ...
      <div className="flex font-poppins flex-col  gap-y-8 justify-center items-center">
        ...
        <Link href={"/#ministering"} onClick={close}>
          {" "}
          Ministering{" "}
        </Link>
        ...
        <button
          ...
          className="w-[240px] border-gray-800 border text-gray-800 py-3 mt-6 font-semibold text-[18px]"
        >
          Register Here
        </button>
      </div>
